  ...
  return (
    <main className="min-h-screen bg-[#0A0C10] text-white p-8">
      <header className="mb-8 text-center">
        ...
        <p className="text-sm uppercase text-gray-400 tracking-[0.3em] mt-1">ALERTS</p>
        <hr className="mt-6 border-[#23272e]" />
      </header>
      <section className="bg-[#111418] p-6 rounded-xl border border-[#23272e]">
        <p className="text-gray-300">Real-time alerts and incident logs will appear here.</p>
      </section>
    </main>
  );
}
